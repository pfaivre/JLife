...
/**
 * Classe utilisée par CommandLineParser pour stocker les paramètre de la ligne de commande.
...
class CommandLineArgument {
  ...
  /**
   * Constructeur de la classe pour un paramètre ne possédant pas de valeur.
  ...
  /**
   * Constructeur de la classe pour un paramètre possédant une valeur.
   * @param key Clé du paramètre.
