 ...
 *   — Un paramètre raccourcit est précédé du signe '-', Exemple : -l
...
class CommandLineParser {
   ...
   * @return Nom du premier paramètre invalide, ou alors null s'ils sont tous valides.
   */
  public String getInvalidArgument(String[] validArguments) {
